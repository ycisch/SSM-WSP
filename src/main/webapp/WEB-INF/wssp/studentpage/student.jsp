		...
		<div id="groupheader-container">
			<div id="wraper">
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item active">
							<img src="${pageContext.request.contextPath }/static/img/教学楼.png" alt="...">
						...
						<div class="item">
							<img src="${pageContext.request.contextPath }/static/img/龙山.jpg" alt="...">
							<div class="carousel-caption">
								<h3 style="color: #000000;">龙山风采</h3>
							</div>
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath }/static/img/保洁.png" alt="...">
							<div class="carousel-caption">
								<h3 style="color: #000000;">保洁风采</h3>
							</div>
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath }/static/img/卫生.png" alt="...">
							<div class="carousel-caption">
			   ...
			   <div id="r-display" class="groupheader-login">
				<form id="v-form" class="bg-info" action="${pageContext.request.contextPath }/target/groupHeader.do" method="">
					<div class="form-group">
						<label for="exampleInputEmail1">ID</label>
						<button id="exit-btn" type="button">x</button>
						<input type="id" class="form-control" id="exampleInputEmail1" placeholder="Id card">
					</div>
					<div class="form-group">
		...
		<nav class="cd-3d-nav-container">
			<ul class="cd-3d-nav3">
				<li class="cd-selected">
					<a target="student-face" href="${pageContext.request.contextPath }/target/stuMountGuard.do">报岗</a>
				</li>
