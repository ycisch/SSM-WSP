...
<html>
	...
	<body>
		...
		<main>
			...
			<div id="wraper-con">
				<iframe name="addBehavior" width="100%" height="600px" border="0"></iframe>
			</div>
		...
		<nav class="cd-3d-nav-container">
			<ul class="cd-3d-nav4">
				<li>
					<a target="addBehavior" href="${pageContext.request.contextPath }/target/myTeamMember.do">我的组员</a>
				</li>

				<li>
					<a target="addBehavior" href="${pageContext.request.contextPath }/target/fillInDaily.do">填写日常</a>
				</li>

				<li>
					<a target="addBehavior" href="${pageContext.request.contextPath }/target/fillInSalary.do">发放工资</a>
				</li>

				<li>
					<a target="addBehavior" href="${pageContext.request.contextPath }/target/fillInYourExperience.do">总结心得</a>
				</li>
			</ul> <!-- .cd-3d-nav -->
