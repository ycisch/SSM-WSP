			...
			<div class="box-login">
				<div class="student-logininterface">
					...
					<div class="logininterface-form">
						<form action="${pageContext.request.contextPath }/target/student.do" method="">
							...
							<div class="logininterface-form-veri">
								<span><i></i></span>
								<input type="text" placeholder="Verification" name="" value="" />
							    <img src="${pageContext.request.contextPath }/static/img/timg1.jpg" >
							</div>
