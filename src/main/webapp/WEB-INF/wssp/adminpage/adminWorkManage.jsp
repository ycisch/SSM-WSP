		...
		<div class="wrapper-asid">		
			...
			<section id="sidebar" class="sidebar">
				...
				<nav>
					...
					<ul>
						<li>
							<a target="workmanage" href="${pageContext.request.contextPath }/target/adminFillInMark.do">代号区域划分</a>
							<i class="font-light"></i>
						</li>
						<li class="ligif"><img src="${pageContext.request.contextPath }/static/img/downarrow.gif" ></li>
						<li>
							<a target="workmanage" href="${pageContext.request.contextPath }/target/adminFillInRelation.do">关联最近区域</a>
							<i class="font-light"></i>
						</li>
						<li class="ligif"><img src="${pageContext.request.contextPath }/static/img/downarrow.gif" ></li>
						<li>
							<a target="workmanage" href="${pageContext.request.contextPath }/target/adminFillInGroupheader.do">分配区域组长</a>
							<i class="font-light"></i>
						</li>
						<li class="ligif"><img src="${pageContext.request.contextPath }/static/img/downarrow.gif" ></li>
						<li>
							<a target="workmanage" href="${pageContext.request.contextPath }/target/adminFillInDlimit.do">院系人数限制</a>
							<i class="font-light"></i>
						</li>
					</ul>
				</nav>
				<div class="wrapper-content">
					<iframe id="wrapper-content" name="workmanage" width="100%" height="100%"></iframe>
				</div>
			</section>
		</div>
