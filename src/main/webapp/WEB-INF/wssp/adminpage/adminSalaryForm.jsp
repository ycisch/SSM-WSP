							...
							<div class="fresh-table">
								...
								<table id="fresh-table" class="table">
									<thead>
										...
										<th data-field="performance level" data-sortable="true">表现等级</th>
										<th data-field="salary" data-sortable="true">报酬(元)</th>
										<th data-field="bank card number" data-sortable="true">工行卡号</th>
